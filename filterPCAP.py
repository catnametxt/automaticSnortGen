# Program which studies a PCAP to pull out 
#     1. Number of packets
#     2. Filter by IPv4/TCP packets
#     3. Filter by IPs
#     4. Identify timestamps and packet numbers
...
# code from https://vnetman.github.io/pcap/python/pyshark/scapy/libpcap/2018/10/25/analyzing-packet-captures-with-python-part-1.html
